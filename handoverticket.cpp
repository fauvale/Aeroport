...
HandOverTicket::HandOverTicket(const QList<Passenger> &listPassengers, QWidget *parent) :
    QDialog(parent),
    mUi(new Ui::HandOverTicket),
...
QList<Passenger> HandOverTicket::listPassengers() const
{
    return m_listPassengers;
}

void HandOverTicket::accept()
{
